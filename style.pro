...
UBUNTU_TRANSLATION_DOMAIN="style.liu-xiao-guo"
...
aptest.commands = bash $$PWD/style/tests/autopilot/run
aptest.depends  = sub-style

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/style/tests/unit
unittest.depends  = sub-style
